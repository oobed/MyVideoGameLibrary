...
// Fetch games with a rating of "T" for the specified user
$sql = "SELECT title, genre, release_date, platform, completed, image_link FROM owned_games WHERE user_id = ? AND rating = 'T'";
...
<html lang="en">
<head>
    <title>User's T-Rated Games</title>
...
<body>
    <h2>Your T-Rated Games</h2>

    <div class="card-container">
        <?php if (empty($games)): ?>
            <p>No T-rated games found in your library.</p>
        <?php else: ?>
